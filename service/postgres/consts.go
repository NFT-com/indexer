...
const (
	...
	actionJobsTableName    = "actions_jobs"
...
var (
	...
	actionJobsTableColumns    = []string{"id", "chain_url", "chain_id", "chain_type", "block_number", "address", "interface_type", "token_id", "action_type", "status"}
