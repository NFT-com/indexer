...
INSERT INTO collections (id, chain_id, contract_collection_id, address, name, description, symbol, slug, standard, uri,
                         website, image_url)
VALUES ('0556dfb2-0281-4483-b36d-0708c50593a8', '94c754fe-e06c-4d2b-bb76-2faa240b5bb8', NULL,
        '0xf75dafa52b05aa5a6bad98d069fa38e38873f442', 'BUNTS', '', 'BNT', 'bunts', 'ERC721', '', '', ''),
       ...
       ('52cfde87-2433-42dc-a5e5-7bf3d8f9933b', '94c754fe-e06c-4d2b-bb76-2faa240b5bb8', NULL,
        ...
        'LAND', 'mavialand', 'ERC721', 'https://be.mavia.com/api/nft/metadata/{{ .nft_id }}',
        'https://www.mavia.com/', ''),
       ...
       ('14bd2888-389a-47b1-93d2-582c695e9426', '94c754fe-e06c-4d2b-bb76-2faa240b5bb8', NULL,
        ...
        'CryptoBears is a collection of 5000 generative NFTs.', 'CB', 'cryptobearsofficiall', 'ERC721', '',
